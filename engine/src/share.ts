 ...
 *
 * Подписи картинки лежат вне реестра микрокопии: в них стоят имя продукта и домен, а они
 * ещё не названы (открытый вопрос 4). Пока хотя бы одна подстановка не заполнена,
