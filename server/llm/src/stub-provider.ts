 ...
 * структурно правильный ответ, чтобы тесты и контур без ключа работали
 * целиком. Настоящая литература — `openrouter`. Внутренние счётчики вроде
 * «проход 6» и «круг 11» в текст не попадают: это не сюжет, а след набора
 * объёма, и его видно человеку.
 *
