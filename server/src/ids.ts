...
/**
 * Токен публичной ссылки. Той же длины и с той же энтропией, но выдаётся
 * отдельно от идентификатора профиля: публичная ссылка не должна давать
 * возможности вычислить личную.
 */
export const newShareToken = generate;
