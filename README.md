...
восьми срезов разбираются и считаются, пороги генерации и следующие двери работают,
несогласие понижает уверенность, правка ответа пересчитывает профиль и щадит купленные
блоки, версии профиля хранятся; дальше порции доборов, кризисный детектор и добор полной
карты из остатка банка.
