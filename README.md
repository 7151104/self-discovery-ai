...
прототип). В работе E2 — движок до полного контура данных: полный банк 35+3 разбирается и
считается, дальше доборы срезов, пороги генерации, кризисный детектор, пересчёт при правке
ответа, добор полной карты из остатка банка.
