 ...
 * через запятую. Кириллица, пробелы и длинные строки машинными не бывают —
 * человеческий текст без пробела длиной до 64 знаков не встречается.
 */
const MACHINE = /^[A-Za-z0-9_.:/@+,-]{1,64}$/;
